...
const app = express();
const PORT = 8080;
const url = 'mongodb+srv://admin:BKINtlX98oa7AfXA@finstox.mp0594u.mongodb.net/?retryWrites=true&w=majority&appName=Finstox';
...
app.post('/register', async(req,res)=>{
  console.log(req.body);  
    const {name,phone, pan, email, password} = req.body;
